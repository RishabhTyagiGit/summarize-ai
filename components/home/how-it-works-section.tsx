...
const HowItWorksSection = () => {
  return (
    <section className="relative overflow-hidden bg-gray-50 py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div
        aria-hidden="true"
        ...
        <div
          ...
          style={{
            clipPath: `polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 
                  89.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 
                  47.5% 58.3%, 45.3% 48.5%, 37.2% 36.7%, 26.4% 6.4%, 
                  9% 17.9%, 100% 27.6%, 76.8% 76.1%, 97.7% 74.1%, 
                  74.4% 1%)`,
          }}
        />
      </div>
...
const StepItem = ({ icon, label, description }: Step) => {
  return (
    <div
      className="flex flex-col gap-4 h-full p-6  rounded-2xl bg-white/5
    backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full"
    >
      <div
        className="flex justify-center items-center h-24 w-24 mx-auto rounded-2xl 
        bg-linear-to-r from rose-500/10 to transparent group-hover: from-rose-500/20 transition-colors"
      >
